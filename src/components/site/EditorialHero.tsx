    ...
    <div className="flex w-full min-w-0 flex-col gap-2.5 sm:gap-3">
      {[
        ...
        <div key={c.t} className={c.float}>
          <article
            className="ed-rise ed-card bg-white !bg-white group/card flex h-[7rem] sm:h-[8rem] flex-col overflow-hidden rounded-[18px] p-3 transition-transform duration-300 hover:-translate-y-1"
