...
function HeroFrame({ image, clips, alt, onReady }: { image: string; clips: string[]; alt: string; onReady?: () => void }) {
  ...
  return (
    <div
      ref={frameRef}
      className="ed-rise ed-frame relative mx-auto aspect-[3/4] w-full max-w-[34rem] sm:max-w-[40rem] lg:absolute lg:inset-0 lg:aspect-auto lg:h-full lg:w-full lg:max-w-none"
