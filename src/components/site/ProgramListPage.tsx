        ...
        {rows.map((r, i) => {
          ...
          <motion.div key={r.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i*0.05 }}
            ...
            <div className="mt-5 flex items-end justify-between">
              ...
              <button onClick={() => setSel({ id: r.id, name: r.name, price: r.price_inr, duration: r.duration ?? "", silverSeatEnabled: !!r.silver_seat_enabled, silverSeatPrice: silverPrice, allowSingle: r.allow_single !== false, allowBoth: !!r.allow_both, bothPrice: r.both_price ?? null })}
