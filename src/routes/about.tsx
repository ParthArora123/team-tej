    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-5 gap-12 pb-24">
        <motion.div initial={{ opacity: 0, scale: 0.96 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
          ...
          <MotionImage src={aboutImg} alt="Founder of Team Tej" width={1200} height={1400} className="h-full w-full" />
        </motion.div>
        <div className="lg:col-span-3 space-y-6 text-lg leading-relaxed text-muted-foreground">
          <p>
            Team Tej began in a borrowed studio in 2013 with six dancers and one stubborn belief — that Indian dance
